...
public class RoutePlanDemo extends Activity implements BaiduMap.OnMapClickListener,
    ...
    public void SearchButtonProcess(View v) {
        ...
        PlanNode stNode = PlanNode.withCityNameAndPlaceName("郑州", editSt.getText().toString());
        PlanNode enNode = PlanNode.withCityNameAndPlaceName("郑州", editEn.getText().toString());
